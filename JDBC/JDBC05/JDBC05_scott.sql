...
AS
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, E.BASICPAY+E.SUDANG Pay
...
--○ 사번 검색 조회
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_NAME, TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, Pay FROM VIEW_EMP WHERE EMP_ID = 1001;

--○ 데이터 수정 쿼리문
UPDATE TBL_EMP
SET EMP_NAME, SSN, IBSADATE, CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울')
WHERE EMP_ID = 
