...
<div>
	<form action="gradeupdate.action" method="post" id="formGr">
		<table>
			<tr>
				<th>번호</th>
				<td>
					<input type="text" name="sid" id="sid" readonly="readonly" value="${search.sid }">
				</td>
			</tr>
			<tr>
				<th>이름</th>
				<td>
					<input type="text" name="name" id="name" readonly="readonly" value="${search.name }">
				</td>
			</tr>
			<tr>
				<th>과목1</th>
				<td>
					<input type="text" name="sub1" id="sub1" value="${search.sub1 }">
			...
			<tr>
				<th>과목2</th>
				<td>
					<input type="text" name="sub2" id="sub2" value="${search.sub2 }">
			...
			<tr>
				<th>과목3</th>
				<td>
					<input type="text" name="sub3" id="sub3" value="${search.sub3 }">
