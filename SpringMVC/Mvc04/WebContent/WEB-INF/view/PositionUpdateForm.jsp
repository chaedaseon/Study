	...
	<div id="content">
		...
		<table>
			<tr>
				<th>번호</th>
				<td>
					<input type="text" id="id" name="id" readonly="readonly" value="${position.positionId }">
				</td>
			</tr>
			<tr>
				<th>이름</th>
				<td>
					<input type="text" id="name" name="name" value="${position.positionName }">
				</td>
			</tr>
			<tr>
				<th>최소기본급</th>
			...
			<tr>
				<td colspan="2" align="center">
					...
					style="width: 40%; height: 50%;">직위 정보 변경</button>
