...
SELECT EMPNO, ENAME, DEPTNO, JOB, COMM
FROM TBL_EMP
WHERE COMM >=ALL (NULL, 300, 500, NULL, 1400, NULL, NULL, NULL, NULL, 0, 10);
--==>> 조회 결과 없음
...
FROM TBL_EMP
WHERE EMPNO IN (7902, 7698, 7698, 7839, 7698, 7839, 7839, 7566, NULL, 7698, 7788, 7698, 7566, 7566, 7698, 7782);
...
--○ 데이터 재수정(TBL_SAWONBACKUP 테이블에서 이름 복사)
UPDATE TBL_SAWON S
SET SANAME = (SELECT SANAME
            FROM TBL_SAWONBACKUP B
            WHERE S.SANO = B.SANO);
--==>> 15개 행 이(가) 업데이트되었습니다.
