...
INSERT INTO TBL_TEST8(COL1, COL2, COL3) VALUES(1, '엄재용', 100);  --> 에러 발생
INSERT INTO TBL_TEST8(COL1, COL2, COL3) VALUES(2, '엄재용', 101);  --> 에러 발생
INSERT INTO TBL_TEST8(COL1, COL2, COL3) VALUES(2, '엄재용', -1);   --> 에러 발생
...
--==>>
/*
HR	SYS_C007026	TBL_TEST8	C	COL3	COL3 BETWEEN 0 AND 100	
HR	SYS_C007027	TBL_TEST8	P	COL1		
*/
...
INSERT INTO TBL_TEST9(COL1, COL2, COL3) VALUES(1, '엄재용', 100);  --> 에러 발생
INSERT INTO TBL_TEST9(COL1, COL2, COL3) VALUES(2, '엄재용', 101);  --> 에러 발생
INSERT INTO TBL_TEST9(COL1, COL2, COL3) VALUES(2, '엄재용', -1);   --> 에러 발생
...
--○ TBL_TESTMEMBER 테이벌의 SSN 컬럼(주민등록번호 컬럼)에서
...
INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(5, '정현욱', '000220-5234567', '010-5555-5555');    --> 에러 발생
INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(5, '정현욱', '000220-6234567', '010-5555-5555');    --> 에러 발생
...
--==>>
/*
HR	SYS_C007039	TBL_EMP1	P	SID		
HR	SYS_C007040	TBL_EMP1	R	JIKWI_ID		NO ACTION
*/
...
INSERT INTO TBL_EMP1(SID, NAME, JIKWI_ID) VALUES(5, '김다슬', 5);  --> 에러 발생
...
, CONSTRAINT EMP2_JIKWI_ID_FK FOREIGN KEY(JIKWI_ID)     -- EMP2 테이블의 JIKWI_ID
             REFERENCES TBL_JOBS(JIKWI_ID)              -- JOBS 테이블의 JIKWI_ID
);
...
WHERE JIKWI_ID=4;
--==>> 에러 발생
--     (ORA-02292: integrity constraint (HR.SYS_C007040) violated - child record found)
...
--2. 형식 및 구조     → NOT NULL의 경우 기본적으로 ① (컬럼 레벨의 형식) 사용
-- ① 컬럼 레벨의 형식 
...
-- 컬럼명 데이터타입,
-- 컬럼명 데이터타입,
-- CONSTRAINT CONTRAINT명 CHECK(컬럼명 IS NOT NULL)
...
-- 4. 기존 테이블에 데이터가 이미 들어있지 않는 컬럼(→ NULL인 상태)을
...
--==>>
/*
HR	SYS_C007047	TBL_TEST11	C	COL2	"COL2" IS NOT NULL	
HR	SYS_C007048	TBL_TEST11	P	COL1		
*/
...
-- 컬럼 레벨에서 NOT NULL 제약조건을 지정한테이블(TBL_TEST11)
DESC TBL_TEST11;
--==>>
/*
이름   널?       유형           
...
HR	TEST13_COL1_PK	TBL_TEST13	P	COL1		
HR	TEST13_COL2_NN	TBL_TEST13	C	COL2	COL2 IS NOT NULL	
HR	SYS_C007053	    TBL_TEST13	C	COL2	"COL2" IS NOT NULL

--> 컬럼 레벨의 형식으로 제약조건을 명시 OR MODIFY절을 이용하여 제약조건을 명시하는 것이 바람직.
    + 제약조건명도 지정해주는 것이 바람직.
*/
...
-- ○ DEFAULT 표현식 적용 실습
-- 테이블 생성
CREATE TABLE TBL_BBS                            -- 게시판 테이블 생성 (예시를 위한 테이블 구성, 실제로는 부적합한 테이블)
...
--==>>
/*
(데이터 입력 중 오류 나서 SID(SEQUENCE)값 중 1이 지나감..!)
2	김다슬	오라클 DEFAULT 표현식을 실습중입니다.	2023-10-31 14:39:10	0	0
3	김다슬	오라클 DEFAULT 표현식을 실습중입니다.	2023-10-31 14:45:02	0	0
4	노은하	계속 실습중입니다.	2023-10-31 14:46:34	0	0
5	문정환	열심히 실습중입니다.	2023-10-31 14:47:11	0	0
6	이윤수	무진장 실습중입니다.	2023-10-31 14:48:07	0	0
*/
