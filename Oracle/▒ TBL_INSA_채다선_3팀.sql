...
--==>>
/*
BIN$8ZJR8ycFTCK/SW/2ltAnUw==$0	TABLE	
BIN$lHUqq/W+TsqaL96x0e9JPA==$0	TABLE	
BONUS	TABLE	
DEPT	TABLE	
EMP	TABLE	
EMP3	TABLE	
...
--==>>
/*
TBL_EMP	    USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	19	8	0	0	0	38	0	0	         1	         1	    N	ENABLED	19	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_BOARD	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	6	5	0	0	0	75	0	0	         1	         1	    N	ENABLED	6	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
...
TBL_DEPT	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	5	8	0	0	0	20	0	0	         1	         1	    N	ENABLED	5	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_SAWON	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	15	5	0	0	0	39	0	0	         1	         1	    N	ENABLED	15	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_WATCH	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	2	5	0	0	0	58	0	0	         1	         1	    N	ENABLED	2	2023-10-20	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_FILES	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	7	5	0	0	0	29	0	0	         1	         1	    N	ENABLED	7	2023-10-20	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_JUMUN	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	12	5	0	0	0	26	0	0	         1	         1	    N	ENABLED	12	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_JUMUNBACKUP	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	20	5	0	0	0	24	0	0	         1	         1	    N	ENABLED	20	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_SAWONBACKUP	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	15	4	0	0	0	39	0	0	         1	         1	    N	ENABLED	15	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT
TBL_INSA	USERS			VALID	10		1	255	65536	1048576	1	2147483645				YES	N	60	5	0	0	0	81	0	0	         1	         1	    N	ENABLED	60	2023-10-27	NO		N	N	NO	DEFAULT	DEFAULT	DEFAULT	DISABLED	YES	NO		DISABLED	YES		DISABLED	DISABLED		NO	NO	YES	DEFAULT	
*/
...
SELECT NAME "이름", SSN "주민번호"
     , EXTRACT(YEAR FROM SYSDATE) - (TO_NUMBER(SUBSTR(SSN, 1, 2)) + 1899) "나이"
FROM TBL_INSA
WHERE SUBSTR(TO_CHAR(EXTRACT(YEAR FROM SYSDATE) - (TO_NUMBER(SUBSTR(SSN, 1, 2)) + 1899)),1,1) = 2;
--==>> 조회 결과 없음
...
--    ( 이름, 출신도, 부서명, 전화번호 )  
SELECT NAME "이름", CITY "출신도", SUBSTR(BUSEO,1,2) "부서", TEL "전화번호"
FROM TBL_INSA
...
--    없으면 '전화번호없음'으로 조회.
SELECT NAME "이름"
     , CASE WHEN TEL IS NOT NULL THEN SUBSTR(TEL, 1, 3)|| SUBSTR(TEL, 5, 4)|| SUBSTR(TEL, 10, 4)
            ELSE '전화번호없음'
            END "전화번호"
FROM TBL_INSA;
--==>>
...
/*        
          ...
          모든사원          XXX
*/
SELECT NVL(T.커미션,'모든사원') "구분", COUNT(*) "인원수"
FROM
(
    SELECT NVL2(COMMISSION_PCT, '커미션받는사원', '커미션없는사원') "커미션"
    FROM EMPLOYEES
)T
...
SELECT '19'||SUBSTR(SSN, 1, 2)||'년' "년도별", COUNT(*) "직원수"
FROM TBL_INSA
...
SELECT *
FROM TBL_INSA
ORDER BY SUBSTR(IBSADATE, 6, 2), SUBSTR(IBSADATE, 1, 4) DESC;
--==>>
/*
1044	지수환	820305-1475286	2004-01-21	서울	011-5555-7548	영업부	사원	1060000	220000
1031	지재환	771115-1687988	2001-01-21	서울	019-5552-7511	기획부	부장	2450000	160000
...
SELECT NVL(T.성별, '전체') "전체", COUNT(*) "인원수"
FROM
(
...
SELECT BUSEO "부서"
     , DECODE(BUSEO, '개발부', COUNT(*), '영업부', COUNT(*), '총무부', COUNT(*)) "인원수"
FROM TBL_INSA
...
SELECT COUNT(DECODE(SUBSTR(SSN, 8,1), '1', '남자', '3', '남자')) "남자인원수"
     , COUNT(DECODE(SUBSTR(SSN, 8,1), '2', '여자', '4', '여자')) "여자인원수"
FROM TBL_INSA
WHERE BUSEO = '영업부';
--==>>
/*
...
SELECT T.성별 "성별", SUM(T.BASICPAY) "기본급합" 
FROM 
(
    SELECT CITY, BASICPAY
...
SELECT AVG(NVL(DECODE(SUBSTR(SSN, 8,1), '1', BASICPAY, '3', BASICPAY), 0)) "남자 기본급 평균"
     , TRUNC(AVG(NVL(DECODE(SUBSTR(SSN, 8,1), '2', BASICPAY, '4', BASICPAY), 0)), -1) "여자 기본급 평균"
FROM TBL_INSA;
--==>>
/*
866020	690500
...
SELECT T.성별, AVG(T.BASICPAY) "기본급 평균값"
FROM 
(
...
SELECT BUSEO "부서"
     , COUNT(DECODE(SUBSTR(SSN, 8,1), '1', '남자', '3', '남자')) "남자인원수"
     , COUNT(DECODE(SUBSTR(SSN, 8,1), '2', '여자', '4', '여자')) "여자인원수"
FROM TBL_INSA
GROUP BY BUSEO;


SELECT M.BUSEO, M."남자", NVL(W."여자", 0)"여자"
FROM
(
    SELECT BUSEO, COUNT(*) "남자"
    FROM TBL_INSA
    WHERE SUBSTR(SSN, 8,1) IN ('1','3')
    GROUP BY BUSEO
) M 
...
SELECT M.CITY, M."남자", NVL(W."여자", 0)"여자"
FROM
(
    SELECT CITY, COUNT(*) "남자"
    FROM TBL_INSA
    WHERE SUBSTR(SSN, 8,1) IN ('1','3')
    GROUP BY CITY
) M 
...
SELECT M.입사년도, M."남자", NVL(W."여자", 0)"여자"
FROM
(
    SELECT TO_CHAR(IBSADATE,'YYYY') "입사년도", COUNT(*) "남자"
    FROM TBL_INSA
    WHERE SUBSTR(SSN, 8,1) IN ('1','3')
    GROUP BY TO_CHAR(IBSADATE,'YYYY')
) M 
LEFT JOIN
(
    SELECT TO_CHAR(IBSADATE,'YYYY') "입사년도", COUNT(*) "여자"
    FROM TBL_INSA
    WHERE SUBSTR(SSN, 8,1) IN ('2','4')
    GROUP BY TO_CHAR(IBSADATE,'YYYY')
) W
...
SELECT BUSEO "부서"
     , COUNT(DECODE(SUBSTR(SSN, 8,1), '1', '남자', '3', '남자')) "남자인원수"
     , COUNT(DECODE(SUBSTR(SSN, 8,1), '2', '여자', '4', '여자')) "여자인원수"
     , SUM(NVL(DECODE(SUBSTR(SSN, 8,1), '1', BASICPAY, '3', BASICPAY), 0)) "남자급여합"
     , SUM(NVL(DECODE(SUBSTR(SSN, 8,1), '2', BASICPAY, '4', BASICPAY), 0)) "여자급여합"
FROM TBL_INSA
WHERE CITY = '서울'
GROUP BY BUSEO;
--==>>
...
SELECT T.BUSEO, T.여자인원수, T.남자인원수
FROM
(
    SELECT BUSEO
         , COUNT(DECODE(SUBSTR(SSN, 8,1), '1', '남자', '3', '남자')) "남자인원수"
...
--    1월    10명
--    2월    25명  
SELECT TO_CHAR(IBSADATE,'MM')||'월' "월별", COUNT(*)||'명' "인원수"
FROM TBL_INSA
...
SELECT NAME, '19'||SUBSTR(SSN, 1,2)||'-'||SUBSTR(SSN,3,2)||'-'||SUBSTR(SSN,5,2) "생년월일"
...
SELECT NAME "이름", IBSADATE "입사일"
FROM TBL_INSA
WHERE EXTRACT(YEAR FROM SYSDATE) - TO_CHAR(IBSADATE, 'YYYY') >= 10;
--==>>
/*
홍길동	1998-10-11
이순신	2000-11-29
...
SELECT NAME "이름", SSN "주민번호", CITY "도시"
FROM TBL_INSA
...
SELECT NAME "이름", IBSADATE "입사일"
FROM TBL_INSA
WHERE EXTRACT(YEAR FROM SYSDATE) - TO_CHAR(IBSADATE, 'YYYY') > 5
 OR EXTRACT(YEAR FROM SYSDATE) - TO_CHAR(IBSADATE, 'YYYY') <= 10;
--==>>
/*
홍길동	1998-10-11
이순신	2000-11-29
...
SELECT NAME "이름", SSN "주민번호"
     , SUBSTR(IBSADATE, 1,4)||'년 '||SUBSTR(IBSADATE,6,2)||'월 '||SUBSTR(IBSADATE,9,2)||'일 '||TO_CHAR(IBSADATE,'DAY') " 입사일"
FROM TBL_INSA
WHERE SUBSTR(SSN,8,1) IN ('1', '3');
--==>>
/*
...
SELECT BUSEO "부서", JIKWI "직위", SUM(BASICPAY) "급여합"
FROM TBL_INSA
...
SELECT BUSEO "부서", JIKWI "직위", COUNT(*) "인원수", SUM(BASICPAY) "급여합", AVG(BASICPAY) "급여평균"
FROM TBL_INSA
GROUP BY BUSEO, JIKWI
ORDER BY BUSEO;
--==>>
...
개발부	사원	9	8965000	996111.1111111111111111111111111111111111
기획부	대리	3	5810000	1936666.66666666666666666666666666666667
...
홍보부	사원	3	2810000	936666.6666666666666666666666666666666667
*/
...
--      60    x    x    x
SELECT COUNT(*) "전체"
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '2005', '1')) "2005년"
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '2004', '1')) "2004년"
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '2003', '1')) "2003년"
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '2002', '1')) "2002년"
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '2001', '1')) "2001년"
     ...
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '1997', '1')) "1997년"
     , COUNT(DECODE(EXTRACT(YEAR FROM IBSADATE), '1995', '1')) "1995년"
FROM TBL_INSA;
--==>>
/*
60	1	5	10	5	9	12	10	6	1	1
*/
...
--      60    x     x     x      
SELECT SUM(COUNT(*)) "전체"
     , SUM(DECODE(CITY, '서울', COUNT(*))) "서울", SUM(DECODE(CITY, '인천', COUNT(*))) "인천"
     , SUM(DECODE(CITY, '경기', COUNT(*))) "경기", SUM(DECODE(CITY, '충남', COUNT(*))) "충남"
     , SUM(DECODE(CITY, '부산', COUNT(*))) "부산", SUM(DECODE(CITY, '제주', COUNT(*))) "제주"
     , SUM(DECODE(CITY, '전남', COUNT(*))) "전남", SUM(DECODE(CITY, '전북', COUNT(*))) "전북"
     , SUM(DECODE(CITY, '강원', COUNT(*))) "강원", SUM(DECODE(CITY, '경북', COUNT(*))) "경북"
     , SUM(DECODE(CITY, '경남', COUNT(*))) "경남"
FROM TBL_INSA
GROUP BY CITY;

--==>>
/*
60	20	9	13	1	3	2	3	5	2	1	1
*/
...
FROM
(
    SELECT TBL_INSA.*,RANK() OVER(ORDER BY BASICPAY DESC) "순위"
    FROM TBL_INSA
) T
WHERE T.순위 <= '5';
--==>>
...
FROM 
(
    SELECT TBL_INSA.*, RANK() OVER(ORDER BY IBSADATE) "순위"
    FROM TBL_INSA
) T
WHERE T.순위 <= '5';
--==>>
...
--85. 남, 여별 기본급 순위 조회.
SELECT T.NAME, T.성별, T.BASICPAY "기본급", RANK() OVER(PARTITION BY T.성별 ORDER BY T.BASICPAY DESC) "순위"
FROM
(
...
SELECT T.NAME, T.CITY, T.BASICPAY+SUDANG "급여"
FROM 
(
    SELECT CITY, NAME, BASICPAY, SUDANG
...
SELECT T.BUSEO, T.부서별인원수
FROM 
(
    SELECT BUSEO, COUNT(*) "부서별인원수", RANK() OVER(ORDER BY COUNT(*) DESC) "순위"
    FROM TBL_INSA
    GROUP BY BUSEO
) T
WHERE T.순위 = '1';
...
SELECT T.CITY, T.지역별인원수
FROM 
(
    SELECT CITY, COUNT(*) "지역별인원수", RANK() OVER(ORDER BY COUNT(*) DESC) "순위"
    FROM TBL_INSA
    GROUP BY CITY
) T
WHERE T.순위 = '1';
...
FROM 
(
    SELECT CITY, AVG(BASICPAY+SUDANG) "평균", RANK() OVER(ORDER BY AVG(BASICPAY+SUDANG) DESC) "순위"
    FROM TBL_INSA
    GROUP BY CITY
) T
WHERE T.순위 = '1';
...
FROM
(
    SELECT BUSEO, COUNT(*) "여자", RANK() OVER(ORDER BY COUNT(*) DESC) "순위"
    FROM TBL_INSA
    WHERE SUBSTR(SSN,8,1) IN ('2', '4')
    GROUP BY BUSEO
) T
...
--    실수령액: 총급여-세금
SELECT T.NAME "이름", T.BUSEO "부서", T.CITY "출신도", T.BASICPAY "기본급"
     , T.SUDANG "수당", T.BASICPAY+SUDANG "기본급+수당", T.세금, T.BASICPAY+SUDANG-T.세금 "실수령액"
FROM
(
...
--    150만원 미만 - C등급
SELECT BUSEO "부서"
     , CASE WHEN AVG(BASICPAY) > 2000000 THEN 'A등급'
