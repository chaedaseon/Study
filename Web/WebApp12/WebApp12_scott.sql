...
SELECT SID, NAME, TEL, KOR, ENG, MAT
     , (KOR+ENG+MAT) AS TOT
...
ORDER BY SID;
--> 한 줄 구성
SELECT SID, NAME, TEL, KOR, ENG, MAT, (KOR+ENG+MAT) AS TOT, (KOR+ENG+MAT)/3 AS AVG, RANK() OVER(ORDER BY (KOR+ENG+MAT) DESC) AS RANK FROM VIEW_MEMBERSCORE ORDER BY SID
;
--==>>
/*
1	노은하	010-1111-1111	91	81	71	243	81	1
2	박가영	010-2222-2222	80	70	60	210	70	2
3	채다선	010-3333-3333	-1	-1	-1	-3	-1	3
4	김수환	010-4444-4444	-1	-1	-1	-3	-1	3
5	김다슬	010-5555-5555	-1	-1	-1	-3	-1	3
*/
